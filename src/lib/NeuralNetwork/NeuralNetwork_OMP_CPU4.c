 ...
 * 
 *   This file implements the fourth of eight different OpenMP-optimised
 *   versions for the CPU. It optimises the innermost loops of the training
 *   function using SIMD.
**/
...
void nn_train(neural_net* nn, size_t n_samples, double** inputs, double** expected, double learning_rate, size_t n_iterations) {
    ...
    for (size_t i = 0; i < n_iterations; i++) {
        for (size_t s = 0; s < n_samples; s++) {
            ...
            // Link the input to the first layer outputs
